...
class BuilddemoController extends AdminController
{
    ...
    {
	    $list = array(
		    array('title'=>'列表示例1','type'=>'listbuild/demo/0','desc'=>'普通的输出示例'),
		    array('title'=>'列表示例2','type'=>'listbuild/demo/1','desc'=>'动态链接和模态窗口示例'),
		    array('title'=>'配置示例1','type'=>'configbuild','desc'=>'输入框相关的示例'),
		    array('title'=>'配置示例2','type'=>'configbuild1','desc'=>'各种选择控件示例'),
		    array('title'=>'配置示例3','type'=>'configbuild2','desc'=>'上传，富文编辑和自动保存配置示例'),
		    array('title'=>'配置示例4','type'=>'configbuild3','desc'=>'选项卡分页配置界面示例'),
		    array('title'=>'排序示例','type'=>'sortbuild','desc'=>'排序页面示例'),
		    array('title'=>'树列示例','type'=>'treebuild','desc'=>'需安装专辑模块'),
	    );
